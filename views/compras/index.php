...
$this->title = 'Comprobantes de Compra';
...
<div class="compras-index"  style="padding-left: 20px;padding-right: 20px;">
	...
	<div class="box box-primary">       
		...
		<div class="box-header with-border"> 
			...
			<h3 class="box-title"><span class="fa fa fa-creative-commons text-aqua"></span>   <?= Html::encode($this->title) ?></h3>
				...
				'beforeHeader'=>[
					[
						'columns'=>[
							...
							['content'=>'Proveedor', 'options'=>['colspan'=>2,'class'=>'text-center warning']], 
							['content'=>'Comprobante', 'options'=>['colspan'=>10,'class'=>'text-center warning']], 
