...
$this->title = 'Actualizar Movimiento Bancario ';
$this->params['breadcrumbs'][] = ['label' => 'Movimiento bancario', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Update';
?>

<section class="movbancos-update" style="padding-left: 20px;padding-right: 20px;"> 
