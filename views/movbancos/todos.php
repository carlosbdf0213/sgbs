...
$this->title = 'Todos los Movimientos Bancarios';
...
<div class="movbancos-index">
	...
	<div class="box box-primary">       
		...
		<div class="box-header with-border"> 
			...
			<h3 class="box-title"><span class="fa fa-retweet text-aqua"></span>   <?= Html::encode($this->title) ?></h3>
		...
		<div class="box-body">
			...
			<?= GridView::widget([
				...
				'beforeHeader'=>[
					[
						'columns'=>[
							['content'=>'Movimientos Bancarios', 'options'=>['colspan'=>12,'class'=>'text-center warning']], 
