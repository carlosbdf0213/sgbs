...
<div class="movbancos-index">
	...
	<div class="box box-primary">       
		...
		<div class="box-header with-border"> 
			...
			<h3 class="box-title"><span class="fa fa-exchange text-aqua"> </span>  <?= Html::encode($this->title) ?></h3>
		...
		<div class="box-body">
			...
			<?= GridView::widget([
				...
				'beforeHeader'=>[
					[
						'columns'=>[
							['content'=>'Transferencias', 'options'=>['colspan'=>12,'class'=>'text-center warning']], 
