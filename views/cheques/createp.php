...
$this->title = 'Nuevo Cheque Propio';
...
<section class="cajas-update" style="padding-left: 20px;padding-right: 20px;"> 
	...
	<section class="box box-primary ">
		...
		<section class="box-header with-border"> 
			...
			<h3 class="box-title"><span class="fa fa-exclamation-triangle text-orange"></span>   <?= Html::encode($this->title) ?> </i></h3>
				...
				<?php $form = ActiveForm::begin(); ?>
					...
					<div class="row">				
						...
						<div class="col-lg-2">
							...
							<?= $form->field($model, 'terceros')->widget(SwitchInput::classname(), 
								[     
									'disabled' => true,
									'pluginOptions' => [
													'onText' => 'No',
