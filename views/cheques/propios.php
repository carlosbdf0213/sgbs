...
<div class="cheques-index" style="padding-left: 20px;padding-right: 20px;">
	...
	<div class="box box-primary">       
		<div class="box-header with-border"> 
			...
			<h3 class="box-title"><span class="fa fa-exclamation-triangle text-orange"> </span>  <?= Html::encode($this->title) ?></h3>
		...
		<div class="box-body">
			...
			<?= GridView::widget([
				...
				'beforeHeader'=>[
					[
						'columns'=>[
							['content'=>'Cheques Propios', 'options'=>['colspan'=>12,'class'=>'text-center warning']], 
						],
					]
				], 
